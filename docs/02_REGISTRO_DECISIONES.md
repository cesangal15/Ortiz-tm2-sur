...
| D47 | Usuarios capataces: albert / angel / ariel / alejandro / robinson — contraseña común cap2025. Contraseñas encargado y chequeadoras: pendientes de definir (reemplazar placeholders enc1-2 y cheq1-2). | ✅ Cerrada | Usuarios distintos por persona garantizan trazabilidad en columna `reporta` de BANDEJA. |
