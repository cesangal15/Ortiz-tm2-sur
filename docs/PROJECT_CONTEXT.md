...
- ELEMENTO se lee de la hoja **BASE** (CC + descripción + PK en rango de abscisas), no se genera como texto. Se resuelve al **Enviar a DATA**. PK cercano (≤30 m) se ajusta al tramo; sin match se marca "REVISAR ·" para que el encargado lo corrija antes de pegar al maestro.
