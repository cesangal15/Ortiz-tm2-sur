...
| 2.11 | Descapote medible en m³ (además/en vez de Ha) y que dispare automático una fila de excavación no aprovechable (encadena ZODME, D17). Extiende D16/D17 y catálogo §1. Pendiente: ¿Ha y m³ o solo m³?; resolver doble conteo con D08 (descapote de la chequeadora). | Usuario |
