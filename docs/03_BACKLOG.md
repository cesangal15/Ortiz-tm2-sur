...
| 2.12 | Arreglar la hoja DATA. **Sin definir aún** — el usuario detallará qué hay que corregir cuando lo aborde. Posible roce con D23 (estructura A–T cerrada) según el tipo de arreglo. | Usuario |
